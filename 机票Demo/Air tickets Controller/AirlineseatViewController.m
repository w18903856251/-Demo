...
- (void)viewDidLoad {
    ...
    SeatHeader.backgroundColor =[UIColor grayColor];
    self.Tickettableview.tableHeaderView = SeatHeader;
...
- (void)requestTicketseatDatas
{
    ...
    [Publicrequest requestTicketseatWithParameters:Ticketseatlist success:^(id obj) {
        ...
        debugLog(@"++++++%ld",ticketEntity.retData.count);
        [weakSelf.Tickettableview reloadData];
